public class StudentGradeCalculator {
    ...
    /**
     * Creates a sample grades.txt file with example data
     */
    ...
    public static double calculateAverageGrade(String fileName) throws java.io.IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            // Split the line into name and grade parts
            String[] parts = line.split("\\s+");
            
            // Skip lines that don't have at least two parts or start with "Average"
            ...
            try {
                ...
                // Skip lines where the grade is not a valid number
    ...
    public static void printStudentGrades(String fileName) throws java.io.IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            // Extract the name (all parts except the last)
